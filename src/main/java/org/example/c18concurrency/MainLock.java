...
public class MainLock {
    public static void main(String[] args) {
        ...
        MessageRepository1 messageRepository1 = new MessageRepository1();

        Thread reader = new Thread(new MessageReader1(messageRepository1),"Reader");
        Thread writer = new Thread(new MessageWriter1(messageRepository1),"Writer");
