...
record Person1(String firstName, String lastName, int age) {
...
public class FirstVisitorMain {
    public static void main(String[] args) {

        var persons = Stream.generate(Person1::new)
                .limit(10)
                .sorted(Comparator.comparing(Person1::lastName))
                .toArray();
